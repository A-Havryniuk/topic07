...
public class Constants {
	...
	public static final String INSERT_USER = "INSERT INTO users (id, login) VALUES (!, ?)";
	...
	public static final String FIND_USER_TEAMS = "SELECT * FROM users_teams WHERE user_id = ?";
